...
2. Choose one of the following:
   ...
   - manual
     1. Go to the BRAT plugin settings and select the `Add beta plugin` button.
...
v1.0.0 has been submitted for review as of 2025-10-5 ([link](https://github.com/obsidianmd/obsidian-releases/pull/8049)). This page will be updated once it has been approved.
