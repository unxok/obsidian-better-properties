...
export type ObsidianDefaultText = {
	"setting": {
		...
		"editor": {
			...
			"option-strict-line-break-description": "Markdown specs ignore single line breaks in reading view. Turn this off to make single line breaks visible.";
			"option-properties-in-document": "Properties in document";
			"option-properties-in-document-description": "Choose how properties are displayed at the top of notes. Select “source” to show properties as raw YAML.";
			...
			"option-auto-pair-markdown-description": "Pair symbols automatically for bold, italic, code, and more.";
			"option-smart-indent-lists": "Smart lists";
			...
			"option-tab-size": "Indent visual width";
			"option-tab-size-description": "Number of spaces a tab character will render as.";
			"option-rtl": "Right-to-left (RTL)";
			"option-rtl-description": "Sets the default text direction of notes to right-to-left.";
			"option-auto-convert-html": "Convert pasted HTML to Markdown";
			"option-auto-convert-html-description": "Automatically convert HTML to Markdown when pasting and drag-and-drop from web pages. Use Ctrl/Cmd+Shift+V to paste HTML without converting.";
			"option-vim-key-bindings": "Vim key bindings";
			"option-vim-key-bindings-description": "Use Vim key bindings when editing.";
		...
		"appearance": {
			"name": "Appearance";
			"option-base-theme": "Base color scheme";
			...
			"option-font-size-description": "Font size in pixels that affects editing and reading views.";
			...
			"option-configure-ribbon": "Ribbon menu configuration";
			"option-configure-ribbon-desc": "Configure what commands appear in the ribbon menu.";
			"option-mobile-quick-ribbon-item": "Quick access ribbon item";
			"option-mobile-quick-ribbon-item-desc": "Choose the behavior of tapping the ribbon button in the navigation menu. By default, this will open a menu showing all your ribbon items.";
			...
			"label-modal-configuration": "Ribbon menu";
		...
		"about": {
			...
			"option-insider-build": "Receive early access versions";
			"option-insider-build-description": "Auto-update to the latest early access version. These versions include new features but may be less stable.";
			"option-advanced": "Advanced";
			...
			"option-catalyst-desc-no-license": "You don't have a Catalyst license. Catalyst is a one-time donation that helps Obsidian remain 100% user-supported and gives you early access to new features.";
			"label-app": "App";
			"label-add-own-language": "Learn how to add a new language to Obsidian.";
		};
		"account": {
			"name": "Account";
		...
		"third-party-plugin": {
			...
			"label-code-review-desc": "Plugins in the official community directory undergo an initial code review by our team before they are listed.";
			...
			"msg-failed-to-uninstall-plugin": "Failed to uninstall plugin “{{id}}”.";
			"msg-failed-to-disable-plugin": "Failed to disable plugin “{{id}}”.";
		...
		"mobile-toolbar": {
			...
			"option-configure-quick-action-description": "Configure which command to trigger when pulling down from the top. The current command is set to “{{command}}”.";
	...
	"interface": {
		...
		"empty-sidebar": "The sidebar is empty, try dragging a tab here.";
		...
		"empty-state": {
			...
			"create-new-file": "Create new note";
			"go-to-file": "Go to file";
			"see-recent-files": "See recent files";
			"close": "Close";
			"close-all": "Close all “{{id}}” tabs ({{count}})";
			"unknown-pane-title": "Plugin no longer active";
			"unknown-pane-desc": "The plugin that created this tab ({{type}}) has gone away.";
		};
		"release-notes": {
		...
		"menu": {
			...
			"open-in-browser": "Open external link";
		...
		"mobile": {
			...
			"action-choose-file-to-insert": "Choose a file...";
			"action-insert-text-into-file": "{{filename}}";
	...
	"dialogue": {
		...
		"msg-files-updated": "Updated {{count}} file.";
	...
	"plugins": {
		...
		"file-explorer": {
			...
			"action-reveal-active-file": "Reveal current file in navigation";
			"command-make-a-copy": "Make a copy of the current file";
			"command-make-a-copy-mac": "Duplicate current file";
			"command-move-file": "Move current file to another folder";
			...
			"label-no-folders": "No existing folders found.";
		...
		"search": {
			...
			"label-explain-search-term": "Explain search terms";
		...
		"quick-switcher": {
			...
			"prompt-type-file-name": "Find or create a note...";
			"label-enter-to-create": "Enter to create";
		...
		"backlinks": {
			...
			"action-show": "Show backlinks";
			"action-open-for-current": "Open backlinks for the current note";
			...
			"ellipsis": "...";
			"option-backlink-in-document": "Show backlinks at the bottom of notes";
			"option-backlink-in-document-desc": "Make backlinks visible in new tabs by default.";
		};
		"outgoing-links": {
			"name": "Outgoing links";
		...
		"bookmarks": {
			...
			"action-remove-bookmark": "Remove bookmark for the current file";
		...
		"markdown-format-importer": {
			...
			"action-open": "Open format converter";
			...
			"frontmatter-migration": "Frontmatter migration";
			"frontmatter-migration-description": "Migrate frontmatter tags, aliases, and cssclasses to the strict format required by Obsidian v1.9+";
			"msg-all-files-warning": "Warning: the converter will convert all the files in your vault, not just the current file.";
		...
		"daily-notes": {
			...
			"action-insert-text": "Today's daily note";
		...
		"publish": {
			...
			"msg-create-site-issue": "There was an issue when creating your site.";
			...
			"option-show-theme-toggle-description": "Let visitors toggle between light and dark theme on their own.";
			...
			"option-sliding-window-mode": "Stack pages";
			"option-sliding-window-mode-description": "Links will open next to the current page in the same window. Scroll horizontally to see stacked pages.";
			...
			"button-add-more-sites": "Add more sites";
		...
		"workspaces": {
			...
			"msg-save-layout-success": "Successfully saved layout “{{name}}”";
		...
		"sync": {
			...
			"action-view-version-history": "Open version history for the current file";
			...
			"label-show-diff": "Show changes";
			"label-copy-to-clipboard": "Copy to clipboard";
			"label-restore-this-version": "Restore";
			...
			"label-file-renamed-from": "Renamed from “{{from}}”";
			...
			"label-empty-file": "Empty content";
			...
			"msg-successfully-created-vault": "Successfully created remote vault “{{name}}”.";
			...
			"label-confirm-delete-remote-vault-question": 'Are you sure you want to delete the remote vault "{{name}}"?';
			...
			"option-device-name-desc": "This name will be displayed in the activity log. Leave empty to use the default name.";
			"button-resume": "Resume";
			"button-pause": "Pause";
			"option-view-deleted-files": "Deleted files";
			"option-view-deleted-files-desc": "View and restore deleted files.";
			"option-sync-log": "Activity log";
			...
			"option-vault-size": "Storage usage";
			...
			"option-currently-excluded-folders": " These folders are currently excluded:";
			...
			"label-manage-excluded-folders": "Manage excluded folders";
			"label-number-of-folders-excluded": "Obsidian Sync is currently excluding {{folders}}.";
			...
			"msg-remote-vault-limit-hit": "You have created the maximum number of remote vaults. In order to create a new remote vault, please upgrade your account or remove an existing one.";
			...
			"label-resolve-conflicts": "Conflict resolution";
			"label-resolve-conflicts-desc": "Choose how conflicts are resolved when a note is independently modified on multiple devices.";
			"option-automatic-merge": "Automatically merge";
			"option-conflict-file": "Create conflict file";
		};
		"file-recovery": {
			"name": "File recovery";
			"desc": "Restore recent snapshots to recover from accidental data loss. Snapshots are only saved for Markdown files.";
			"action-open": "Open local history";
			...
			"option-keep-description": "Number of days the snapshots are kept for.";
			...
			"option-clear-description": "Delete all snapshots.";
			"button-clear-history": "Clear";
			"label-clear-warning": "Are you sure you want to delete all snapshots? Files inside your vault will not be affected.";
			"msg-clear-complete": "Local history cleared.";
			"label-no-history-found": "Snapshots found.";
		...
		"web-viewer": {
			...
			"label-fail-to-load": "Unable to load site.";
			"label-fail-to-load-desc": "Make sure you have the correct address.";
			...
			"msg-error-extracting-content": "Unexpected error extracting content.";
		...
		"canvas": {
			...
			"option-node-label": "Show card names";
			...
			"action-narrow-bases-view": "Pin view...";
			...
			"label-show-default-view": "Show default view";
			...
			"msg-updating-links": "Canvas detected file renames affecting {{count}} canvas file, updating...";
			"msg-updating-links_plural": "Canvas detected file renames affecting {{count}} canvas files, updating...";
			"msg-updated-links": "Canvas updated {{count}} embed card";
			"msg-updated-links_plural": "Canvas updated {{count}} embed cards";
		};
		"bases": {
			"name": "Bases";
			...
			"label-file-prop-name": "file name";
			"label-file-prop-base-name": "file base name";
			"label-file-prop-full-name": "file full name";
			"label-file-prop-path": "file path";
			"label-file-prop-folder": "folder";
			"label-file-prop-ext": "file extension";
			"label-file-prop-ctime": "created time";
			"label-file-prop-mtime": "modified time";
			"label-file-prop-size": "file size";
			"label-file-prop-backlinks": "file backlinks";
			"label-file-prop-links": "file links";
			...
			"label-sort-a-z": "A → Z";
			"label-sort-z-a": "Z → A";
			"label-sort-old-new": "Old to new";
			"label-sort-new-old": "New to old";
			"label-sort01": "0 → 1";
			"label-sort10": "1 → 0";
			...
			"msg-error-invalid-property-config": 'Invalid property config for "{{ name }}".';
			...
			"msg-error-invalid-property": "Invalid property";
			"msg-new-item-filtered": "This note will be filtered out because it doesn't match your criteria";
			"placeholder-filter-advanced-mode": "Advanced filter";
			...
			"cards": {
				...
				"label-image-property": "Image property";
				"label-image-fit": "Image fit";
				"option-image-fit-cover": "Cover";
				"option-image-fit-contain": "Contain";
				"label-image-aspect-ratio": "Image aspect ratio";
			};
			"table": {
				"name": "Table";
				"action-hide-column": "Hide column";
				"action-edit-property": "Edit property...";
				"action-edit-formula": "Edit formula...";
				"action-sort-default": "Clear sort";
				"action-sort-a-z": "Sort A → Z";
				"action-sort-z-a": "Sort Z → A";
	...
	"formulas": {
		"msg-error-parse-formula": 'Failed to parse formula "{{ formula }}"';
		"msg-error-invalid-function": 'Cannot find function "{{ function }}"';
		"msg-error-invalid-instance-function": 'Cannot find function "{{ function }}" on type {{ type }}';
		"msg-error-not-enough-arguments": 'Cannot call function "{{ function }}", not enough arguments.';
		"msg-error-too-many-arguments": 'Cannot call function "{{ function }}", too many arguments.';
		"msg-error-type-error": 'Type error in "{{ function }}", parameter "{{ parameter }}". Expected {{ expected }}, given {{ given }}.';
		"msg-error-invalid-array-access": 'Cannot access index "{{ index }}" of non-array value';
		"msg-error-invalid-object-access": 'Cannot find "{{ index }}" on type {{ type }}';
		"funcs": {
			"label-global-now": "Returns a date object representing the current moment.";
			"label-global-today": "Returns a date object representing the current date. The time portion is set to zero.";
			"label-global-date": "Returns a date object representing the parsed input timestamp or date object.";
			...
			"label-global-duration": "Parse a string as a duration.";
			...
			"label-string-trim": "Removes whitespace from both ends of the string.";
			"label-string-title": "Converts the string to title case (first letter of each word capitalized).";
			"label-string-is-empty": "Returns true if the string has no characters, or is not present.";
			"label-string-replace": "Returns a string with occurrences of `pattern` replaced with the `replacement`.";
			"label-string-lower": "Returns the string converted to lower case.";
			"label-string-split": "Returns an list of `n` substrings by splitting on `separator`.";
			"label-string-contains": "Returns true if the string contains `value`.";
			"label-string-contains-any": "Returns true if the string contains at least one of the `values`.";
			"label-string-contains-all": "Returns true if the string contains all of the `values`.";
			"label-string-slice": "Returns a substring from `start` (inclusive) to `end` (exclusive).";
			"label-string-repeat": "Returns a string that is constructed from repeating this string the specified times.";
			"label-number-abs": "Returns the absolute value of the number.";
			"label-number-floor": "Rounds the number down to the nearest integer.";
			"label-number-ceil": "Rounds the number up to the nearest integer.";
			"label-number-round": "Rounds the number to the nearest integer.";
			...
			"label-list-unique": "Removes duplicate elements.";
			"label-list-contains": "Returns true if the list contains `value`.";
			"label-list-contains-any": "Returns true if the list contains at least one of the `values`.";
			"label-list-contains-all": "Returns true if the list contains all of the `values`.";
			"label-list-slice": "Returns a shallow copy of a portion of the list from `start` (inclusive) to `end` (exclusive).";
			...
			"label-object-map": "Transform each key value pair of this object into a list by calling a conversion function, which uses the variables `key` and `value`, and returns the new value to be placed in the list.";
			"label-object-filter": "Filter the elements of this object by calling a filter function, which uses the variables `key` and `value`, and returns a boolean value for whether the element should be kept.";
			"label-reg-exp-matches": "Returns true if the regular expression matches `value`.";
			"label-date-format": "Returns the date formatted as specified by a Moment.js format string.";
			"label-date-date": "Returns a date object with the time removed.";
			"label-date-time": "Returns the time.";
			"label-date-relative": "Returns a readable comparison of the date to the current datetime.";
			"label-date-is-empty": "Returns false.";
			"label-file-as-link": "Returns a Link object that renders as a functioning link.";
			"label-file-has-link": "Returns true if `file` links to `otherFile`.";
			"label-file-in-folder": "Returns true if the file is in the specified folder.";
			"label-file-has-tag": "Returns true if the file has any of the tags in `values`.";
			"label-file-has-property": "Returns true if the note has the given file property.";
			"label-link-links-to": "Returns whether the file represented by the `link` has a link to `file`.";
			"label-link-as-file": "Returns a file object if this links resolves to one.";
			"label-tag-matches": "Returns if the given string matches the current tag.";
		};
	};
	"pdf": {
	...
	"properties": {
		...
		"label-change-property-type": "Display as {{type}}?";
		"label-change-property-type-desc": "Your {{oldType}} data is not compatible. It will be adapted to fit the new format.";
	};
	"table": {
		"label-column": "Column";
		"label-row": "Row";
		"action-row-after": "Add row below";
		"action-column-after": "Add column to the right";
		"action-row-before": "Add row above";
		"action-row-up": "Move row up";
		"action-row-down": "Move row down";
		"action-column-before": "Add column to the left";
	...
	"nouns": {
		...
		"result-with-count": "{{count}} result";
		"result-with-count_plural": "{{count}} results";
