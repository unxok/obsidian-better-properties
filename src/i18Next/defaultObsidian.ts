...
type Text = {
	"setting": {
		...
		"editor": {
			...
			"option-use-tabs-description": "Use tabs to indent by pressing the “Tab” key. Turn this off to indent using up to 4 spaces.";
			"option-tab-size": "Tab indent size";
		...
		"account": {
			...
			"option-commercial-license-desc": "A commercial license is required if you use Obsidian for work within a for-profit company of two or more people.";
	...
	"plugins": {
		...
		"sync": {
			...
			"label-file-renamed-from": "Renamed from “{{filepath}}”";
		...
		"file-recovery": {
			...
			"option-keep-description": "Length in days snapshots are kept for.";
		...
		"browser": {
			...
			"label-browser-data": "Browser data";
			"label-clear-data": "Clear browser data";
			...
			"option-enable-adblock-desc": "If enabled, the filter lists below will be applied to all browser tabs.";
			...
			"title-clear-data-modal": "Clear browser data";
		};
		"canvas": {
			"name": "Canvas";
...
export const obsidianText = (key: NestedPaths<Text>) => {
	// @ts-expect-error Due to my overriding of the types for my own use with i18next, there isn't a way to have TS like this
	return i18next.getFixedT()(key) as string;
};
